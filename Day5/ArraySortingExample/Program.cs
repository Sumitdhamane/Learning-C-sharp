...
namespace ArraySortingExample
{
    internal class Program
    {
        ...
        static void Main2()
        {
            ...
            Array.Sort(arr, new Employee1()); //IComparer ---> EmpNo


            //Array.Sort(arr, new Class1()); //IComparer ----> Basic
            //Array.Sort(arr, new Class2()); //IComparer -----> Name
    ...
    public class Class2 : IComparer<Employee1>
    {
    ...
    public class Employee2 : IComparable<Employee2>//:IComparable// : IComparable<Employee2>
    {
        public int EmpNo { get; set; }
        public string Name { get; set; }
        public decimal Basic { get; set; }
    ...
    public class EmpTemp : IComparable
    {
        public int EmpNo { get; set; }
        public string Name { get; set; }
        public decimal Basic { get; set; }
        ...
        //public int CompareTo(EmpTemp? other)
        //{
        //    throw new NotImplementedException();
        //}
